 ...
 */
final class Version20190910142126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, tricks_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, texte VARCHAR(255) DEFAULT NULL, INDEX IDX_6A2CA10C3B153154 (tricks_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
